    ...
    public class SteamVR_Behaviour_Skeleton : MonoBehaviour
    {
        ...
        */
        ...
        protected virtual void Awake()
        {
            ...
            {
                unityHand = InputDevices.GetDeviceAtXRNode(XRNode.LeftHand);
            }
            else
            {
                unityHand = InputDevices.GetDeviceAtXRNode(XRNode.RightHand);
            }
            SteamVR.Initialize();
        ...
        protected virtual void UpdatePose()
        {
            ...
            if (skeletonAction == null)
            {
                unityHand.TryGetFeatureValue(CommonUsages.devicePosition, out skeletonPosition);
                unityHand.TryGetFeatureValue(CommonUsages.deviceRotation, out skeletonRotation);
            }
            else
            {
                skeletonPosition = skeletonAction.GetLocalPosition();
                skeletonRotation = skeletonAction.GetLocalRotation();
